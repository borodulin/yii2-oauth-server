<?php  //[STAMP] 1f3844483b412bb12580df18a4c036f7
...
trait FunctionalTesterActions
{
     ...
     *                              Default is true.
     * @see \oauth\tests\RedirectHelper::followRedirects()
     */
     ...
     *
     *
     * @see \oauth\tests\RedirectHelper::grabHeader()
     */
    public function grabHeader($header) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabHeader', func_get_args()));
    }
     ...
     * @see \oauth\tests\RedirectHelper::seeHeaderContains()
     */
    public function canSeeHeaderContains($header, $text) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeHeaderContains', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeHeaderContains($header, $text) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeHeaderContains', func_get_args()));
    }
